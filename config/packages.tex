...
% ── Grafiken ──────────────────────────────────────────────────
\usepackage{graphicx}
\usepackage{float}   % erlaubt [H] fuer feste Platzierung ohne Absatz-Unterbrechung
...
% ============================================================
% Zitation per Fußnote (Vorgabe des Dozenten, vgl. ITM-Leitfaden Abschn. 6.2.1):
% im Text \footcite[Vgl.][S.~x]{key} verwenden; direkte Zitate ohne "Vgl.".
\usepackage[
  backend=biber,
  style=authoryear,
  autocite=footnote,
