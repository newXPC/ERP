...
\phantomsection\label{anh:eventlog}
\section*{Anhang I: Auszug aus dem Event-Log}
\addcontentsline{toc}{section}{Anhang I: Auszug aus dem Event-Log}

Der folgende Auszug zeigt zwei repräsentative Fälle aus dem synthetischen Log, nämlich einen Happy-Path-Fall (800002) und einen Fall mit Liefersperre, Falschlieferung, Gutschrift und Nachlieferung (800347). Ein Fall mit Kreditsperre und Auftragsänderung ist in Tabelle~\ref{tab:fall-800012} dargestellt. Alle Ressourcenkennungen sind synthetisch.
...
\phantomsection\label{anh:parameter}
...
\phantomsection\label{anh:kennzahlen}
...
\phantomsection\label{anh:prompts}
...
\\[1.2em]
\textbf{Prompt 6} &
Kannst du die Hausarbeit auf Grammatik- und Rechtschreibfehler überprüfen? (Fable 5)
\\[1.2em]
\end{longtable}}