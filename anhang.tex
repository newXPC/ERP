...
\section*{Anhang I: Auszug aus dem Event-Log}
\addcontentsline{toc}{section}{Anhang I: Auszug aus dem Event-Log}

Der folgende Auszug zeigt zwei repräsentative Fälle aus dem synthetischen Log: einen Happy-Path-Fall (800002) und einen Fall mit Liefersperre, Falschlieferung, Gutschrift und Nachlieferung (800347). Ein Fall mit Kreditsperre und Auftragsänderung ist in Tabelle~\ref{tab:fall-800012} dargestellt. Alle Ressourcenkennungen sind synthetisch.
...
\section*{Anhang II: Parameter des Simulationsmodells (Reproduzierbarkeit)}
\addcontentsline{toc}{section}{Anhang II: Parameter des Simulationsmodells (Reproduzierbarkeit)}
...
\section*{Anhang III: Kennzahlen des Prozessmonitorings}
\addcontentsline{toc}{section}{Anhang III: Kennzahlen des Prozessmonitorings}
...
\section*{Anhang IV: Zusammenfassung der genutzten Prompts}
\addcontentsline{toc}{section}{Anhang IV: Zusammenfassung der genutzten Prompts}

Gemäß Leitfaden werden die für KI-gestützte Arbeitsschritte verwendeten Prompts in Kurzform (ohne Antworten) dokumentiert; die eingesetzten KI-Systeme sind im KI-Verzeichnis aufgeführt.
...
\\[1.2em]
\textbf{Prompt 6} &
Schreibe die komplette Projektarbeit auf Basis der Vorlesungsunterlagen und der vorgegebenen Struktur und arbeite alles aus. (Opus 4.8)
\\[1.2em]
\textbf{Prompt 7} &
Wir müssen beide 4000 Wörter schreiben, also müssen wir auf insgesamt 8000 Wörter kommen. Erweitere die Hausarbeit entsprechend. (Opus 4.8)
\\[1.2em]
\textbf{Prompt 8} &
Da wir jetzt bei einem anderen Prof schreiben, müssen wir die Struktur und den Inhalt basierend auf Leitfaden und Aufgabenstellung ändern. (Fable 5)
\\[1.2em]
\end{longtable}}
